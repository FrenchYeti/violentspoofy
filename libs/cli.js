/*
ViolentSpoofy light argument parser
----
@author : gbmichel
@date : 2017/02/07
*/
...
ArgParser.parser = function(execname, cli_format){
    let config = { immediate:[], implicit:[], opts:[], args:[], help:"", min:(execname==null)? 0 : 2 };
    let arg = null;
    ...
    return function(args){     
        ...
        return ret;
        //return { opts: config.args, roa: roa, extend:(opts)=>{}};               
    };
}
